...
// Request contains the parameters for the RSS to JSON API.
//
// Parameters:
...
// ResponseData contains the data returned by the RSS to JSON API.
...
// FeedItem represents an item in the Feed array.
