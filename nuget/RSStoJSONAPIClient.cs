...
namespace APIVerve.API.RSStoJSON
{
    ...
    /// <summary>
    /// Client for the RSStoJSON API
    /// </summary>
    public class RSStoJSONAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/rsstojson";
        ...
        public RSStoJSONAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RSStoJSONAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RSStoJSONAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RSStoJSONQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RSStoJSONQueryOptions options)
        {
        ...
        public ResponseObj Execute(RSStoJSONQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RSStoJSONQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RSStoJSONQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RSStoJSONQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RSStoJSONQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RSStoJSONQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RSStoJSONQueryOptions options)
        {
