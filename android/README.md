...
```gradle
dependencies {
    implementation 'com.github.apiverve:rsstojson-api:1.1.14'
}
```
...
```java
import com.apiverve.rsstojson.RSStoJSONAPIClient;
import com.apiverve.rsstojson.APIResponse;
import com.apiverve.rsstojson.APIException;

// Initialize the client
RSStoJSONAPIClient client = new RSStoJSONAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("url", "https://www.nasa.gov/rss/dyn/breaking_news.rss");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/rsstojson](https://docs.apiverve.com/ref/rsstojson)
...
- **Documentation:** [https://docs.apiverve.com/ref/rsstojson](https://docs.apiverve.com/ref/rsstojson)
- **Issues:** [GitHub Issues](https://github.com/apiverve/rsstojson-api/issues)
